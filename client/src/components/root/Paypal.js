...
export default class Paypal extends React.Component {
    render() {
        ...
        const onSuccess = (payment) => {
            ...
            axios.post(`http://localhost:${process.env.PORT}/paid`, this.props.paydata)
        }
        ...
        const client = {
            sandbox: 'AbGB-acyLH0q-ePS4rhbiz0SQiObcTHvAgqUrG-RYsXv_bVZ77jVBRS5eikmrdKYg2uhSkQN6-AFlycc',
            production: 'AVk70nO1OEUpCJvQ_AGt1-Ijv_KYbi-pbYWiWO7naEBZySQ0eQmkU5zYoSzIu3J_KW_FoPaS18Euf1Nh',
        }
